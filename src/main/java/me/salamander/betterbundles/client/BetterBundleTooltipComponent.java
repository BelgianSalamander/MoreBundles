package me.salamander.betterbundles.client;
...
public class BetterBundleTooltipComponent implements TooltipComponent {
    private final DefaultedList<ItemStack> items;
    private final int occupancy;
    private final int itemAmount;
    public static float itemScale = 1.0f;

    public BetterBundleTooltipComponent(BundleTooltipData bundleData){
